...
<div class="container mt-5">
        <h1 class="text-center mb-4">Player Information</h1>
        <!-- Sports Card Section -->
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <p class="card-text"><strong>PLayer ID : </strong>{{$data->id}}</p>
                        <h5 class="card-title">Player Name : <span class="text-primary">{{$data->player_name}}</span></h5>
